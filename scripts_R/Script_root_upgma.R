...
plot(arbre, main = titre_arbre, cex.main = 2, edge.width=3, cex = 1.2, tip.color = "aquamarine4", font = 4)
nodelabels(pch = 19, cex = 1.5, col = "aquamarine4")
edgelabels(adj = c(0.5, -0.25), round(arbre$edge.length, 3), cex = 1.0, frame = "none", offset = 3, col = "aquamarine4")
axisPhylo()
